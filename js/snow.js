...
var snowStorm = (function(window, document) {
  ...
  this.targetElement = document.getElementsByTagName("nav")[0];      // element which snow will be appended to (null = document.body) - can be an element ID eg. 'myDiv', or a DOM node reference
